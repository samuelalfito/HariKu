...
object TextElementMapper {
    fun toFirestoreMap(textElement: TextElement): Map<String, Any?>{
        return hashMapOf(
            ...
            "shadowColor" to textElement.shadowColor.value, // Ganti
            "shadowOpacity" to textElement.shadowOpacity,
            "outlineWidth" to textElement.outlineWidth,
            "outlineColor" to textElement.outlineColor.value, // Ganti
    ...
    fun fromFirestoreMap(data: Map<String, Any?>): TextElement {
        return TextElement(
            ...
            shadowX = data["shadowX"] as Float,
            shadowY = data["shadowY"] as Float,
            shadowRadius = data["shadowRadius"] as Float,
            shadowColor = Color(data["shadowColor"] as Long), // Ganti
            shadowOpacity = data["shadowOpacity"] as Float,
            outlineWidth = data["outlineWidth"] as Float,
